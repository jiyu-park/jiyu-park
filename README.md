...
낯선 기술도 직접 구현하며 이해하고, 시행착오를 통해 <strong>더 나은 방식</strong>을 찾아갑니다.
<br><br>
데이터 분석, 관광 정보 추천, 계약서 검토 서비스 프로젝트를 진행하며<br>
데이터 처리부터 API 설계와 서비스 연동까지 경험을 넓혀가고 있습니다.
<br><br>
책임감 있는 실행과 명확한 소통으로,<br>
오늘 마주한 문제를 내일의 더 나은 선택으로 연결하며<br>
